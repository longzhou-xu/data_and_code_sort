...
title('a','FontName','Arial','FontSize',24, 'FontWeight', 'bold', 'units','normalized','position',[-1/12,1+1/30],'HorizontalAlignment','right','VerticalAlignment','bottom');
...
text(0.07,0.97,['$THR_{SC}=',num2str(S_thr),'$'],'units', 'normalized',...
        'Interpreter','latex','Color',[0.00,0.00,0.00],'FontName','Arial','FontSize',17,'EdgeColor','none');
title('b','FontName','Arial','FontSize',24, 'FontWeight', 'bold', 'units','normalized','position',[-1/12,1+1/30],'HorizontalAlignment','right','VerticalAlignment','bottom');
grid off; AX1.LineWidth=2; box(AX1,'off'); hold off
...
text(0.07,0.97,['$THR_{SC}=',num2str(S_thr),'$'], 'units', 'normalized', ...
        'Interpreter','latex','Color',[0.00,0.00,0.00],'FontName','Arial','FontSize',17,'EdgeColor','none');
title('c','FontName','Arial','FontSize',24, 'FontWeight', 'bold', 'units','normalized','position',[-1/12,1+1/30],'HorizontalAlignment','right','VerticalAlignment','bottom');
grid off; AX1.LineWidth=2; box(AX1,'off'); hold off
...
text(0.07,0.97,['$THR_{SC}=',num2str(S_thr),'$'], 'units', 'normalized', ...
        'Interpreter','latex','Color',[0.00,0.00,0.00],'FontName','Arial','FontSize',17,'EdgeColor','none');
title('d','FontName','Arial','FontSize',24, 'FontWeight', 'bold', 'units','normalized','position',[-1/12,1+1/30],'HorizontalAlignment','right','VerticalAlignment','bottom');
grid off; AX1.LineWidth=2; box(AX1,'off');  hold off
