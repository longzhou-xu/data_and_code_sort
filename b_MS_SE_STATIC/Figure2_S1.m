% measure the correlation between the MS
clc;clear;close all;
...
%% plot the MS-SE relationship in HY96
load('MS_SE_HY96_RS.mat') % load data
SE_HY96 = synE; 
MS_HY96 = syn;  
clear syn synE subject KOP
load('HMS_MMS_LMS_subject.mat') % load the MMS, LMS and HMS subject index
AX1 = subplot(2,3,1);
...
hold on
f2 = plot(MS_HY96(subcri_subject_number(:,3)),...
    SE_HY96(subcri_subject_number(:,3)),...
    'Color',[0,0,1],...
    'Marker','o',...
    'MarkerSize',6,...
    'LineWidth',2,...
    'LineStyle','none');
f3 = plot(MS_HY96(cri_subject_number(:,3)),...
    SE_HY96(cri_subject_number(:,3)),...
    'Color',[0,1,0],...
    'Marker','o',...
    'MarkerSize',6,...
    'LineWidth',2,...
    'LineStyle','none');
f4 = plot(MS_HY96(suppercri_subject_number(:,3)),...
    SE_HY96(suppercri_subject_number(:,3)),...
    'Color',[1,0,0],...
    'Marker','o',...
    'MarkerSize',6,...
    'LineWidth',2,...
    'LineStyle','none');% select the LMS MMS and HMS subejct in HY96
