...
for subject=1:295
    ...
    load(['D:\criticality_cognitive\project_synchrony_avalanche',...
        '_fluid_Iq\a_extract_the_signals_from_HCP_files\ROI_sign',...
        'als\HY_96\sub', num2str(subject), '.mat']);
    ...
    I=0;
    for threshold = 0.12 : 0.02 : 0.48 % 0.12 : 0.02 : 0.48
        I=I+1;
        J=0;
        for win_number = 40 : 2 : 60 % 40 : 2 : 60
            J=J+1;
...
save('flexibility_supple', 'CNE_subject', 'CNE_ROI');
