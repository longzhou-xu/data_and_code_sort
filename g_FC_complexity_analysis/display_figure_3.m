...
f1=plot(F3_a.MSoutlier_1, F3_a.FCentropyOutlier_1, ...
    'color',[1,0,0],'Marker','<','MarkerSize',6,'LineStyle','none','LineWidth',2);
...
title('A','FontName','Arial','FontSize',24,  ...
    'units','normalized','position',[-1/18,1],'HorizontalAlignment','right','VerticalAlignment','bottom');
...
save('figure_3.mat','F3_a','F3_b','F3_c');