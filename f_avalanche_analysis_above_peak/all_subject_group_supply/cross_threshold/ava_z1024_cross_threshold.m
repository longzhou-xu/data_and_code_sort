...
for Threshold = 3.4 : 0.1 : 3.4 
    ...
    save(['z_1024\Z1024_above_event_', num2str(Threshold), '.mat'],'Event_serise');
end
save('z_1024\Avalanches_define.mat', 'BinE', 'AvaS', 'DurT', 'AvaSH', 'AvaDH', 'BP', 'BP_other');
%%
clc; clear; close all
load('z_1024\Avalanches_2.9.mat')
SizeFitRange = [9,50];
...
load('z_1024\Avalanches_define.mat', 'BP_other')
figure(...
      'Color', 'w', ...
      'Units', 'Normalized', ...
...
AX1 = subplot(1,1,1);
plot(syn, BP_other(:,10,1) ,...
    'Color', [0.50, 0.50, 0.50], ...
    'LineStyle', 'none', ...
    'LineWidth', 2, ...
    'Marker', 'o', ...
    'MarkerSize',6);
[R,P] = corr(syn, BP_other(:,10,1));
xlabel('MS');
ylabel('BP')
grid off; 
AX1.LineWidth = 2; 
...
clc;clear;close all;
Threshold = 3.6;
cd('D:\supplyment_dataANDcode\k_avalanche_analysis_grouply_other_method\z_1024')
load('D:\supplyment_dataANDcode\c_MS_SE_static\MS_SE_HY96_RS.mat', 'syn')
...
clc;clear;close all
cd('D:\supplyment_dataANDcode\k_avalanche_analysis_grouply_other_method\z_1024');
load('Avalanches_LMS_3.6.mat')
load('Avalanches_MMS_3.6.mat')
load('Avalanches_HMS_3.6.mat')
figure(...
      'Color', 'w', ...
      'Units', 'Normalized', ...
      'Name',  'Power law analysis', ...
