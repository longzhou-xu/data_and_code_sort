...
for Threshold = 1.95 : 0.1 : 1.95
    ...
    save(['HY_96\Avalanches_', num2str(Threshold), '.mat'], ...
        'Threshold', 'AvaS_AllSubject', 'AvaD_AllSubject', 'BinE_AllSubject');
    save(['HY_96\HY96_above_event_', num2str(Threshold), '.mat'],'Event_serise');
end
save('HY_96\Avalanches_define.mat', 'BinE', 'AvaS', 'DurT', 'AvaSH', 'AvaDH', 'BP', 'BP_other');
%%
clc; clear; close all
...
load('HY_96\Avalanches_define.mat', 'BP_other')
figure(...
      'Color', 'w', ...
      'Units', 'Normalized', ...
...
%%
clc;clear;close all
cd('D:\supplyment_dataANDcode\k_avalanche_analysis_grouply_other_method\HY_96');
load('Avalanches_LMS_2.7.mat')
load('Avalanches_MMS_2.7.mat')
load('Avalanches_HMS_2.7.mat')
figure(...
      'Color', 'w', ...
      'Units', 'Normalized', ...
      'Name',  'Power law analysis', ...
