...
for Threshold = 1.7 : 0.1 : 1.7
    ...
    for S=1:295 % subject
       ...
       %% Avalanche analysis
        ...
        Event_rate(1:1200,S) = Event_sum(1:1200,S)/246;
        Event_CV(S) = std(Event_rate(1:1200,S))/mean(Event_rate(1:1200,S));
        clear Event 
    end
    [BP_allsubject]=branchingParameter(BinE_AllSubject);
    save(['BN_246\Avalanches_', num2str(Threshold), '.mat'], ...
        'Threshold', 'AvaS_AllSubject', 'AvaD_AllSubject', ...
        'BinE_AllSubject','Event_sum','Event_rate','Event_CV');
    save(['BN_246\BN246_event_', num2str(Threshold), '.mat'],'Event_serise');
end
save('BP.mat','BP_allsubject');
save('BN_246\Avalanches_define.mat', 'BinE', 'AvaS', 'DurT', 'AvaSH', 'AvaDH', 'BP', 'BP_other');
%% The secend part: avalanche define of different threshold
clc;clear;close all
addpath('D:\the_code_and_results_sort\supplyment_dataANDcode\z_function\CritAnalysisSoftwarePackage2016-04-25');
I_T = 0;
for Threshold = 1 : 0.1 : 2.8
    I_T = I_T + 1;
    AvaS_AllSubject = [];
    AvaD_AllSubject = []; 
    BinE_AllSubject = [];
    ...
    [BP_allsubject(I_T)]=branchingParameter(BinE_AllSubject);
    save(['BN_246_1\Avalanches_', num2str(Threshold), '.mat'], ...
        'Threshold', 'AvaS_AllSubject', 'AvaD_AllSubject', ...
        'BinE_AllSubject','Event_sum','Event_rate','Event_CV');
    save(['BN_246_1\BN246_event_', num2str(Threshold), '.mat'],'Event_serise');
end
save('BN_246_1\Avalanches_define.mat', 'BinE', 'AvaS', 'DurT', 'AvaSH', 'AvaDH', 'BP', 'BP_other');
save('BN_246_1\BP.mat','BP_allsubject');
%% plot the event points figure of BN-246
clc;clear;close all
load('Avalanches_1.7.mat', 'Event');% load the data of event
...
title('MS=0.6866', ...
      ...
      'FontSize', 20, ...
      'FontWeight', 'bold');
%% the avalanches analysis for LMS group
clc;clear;close all;
Threshold = 1.7;
cd('D:\supplyment_dataANDcode\b_avalanche_analysis_grouply\BN_246')
...
%% the avalanches analysis for MMS group
clc;clear;close all;
Threshold = 1.7;
cd('D:\supplyment_dataANDcode\b_avalanche_analysis_grouply\BN_246')
load('D:\supplyment_dataANDcode\c_MS_SE_static\MS_SE_HY96_RS.mat', 'syn')
...
%% the avalanches analysis for HMS group
clc;clear;close all;
Threshold = 1.7;
cd('D:\supplyment_dataANDcode\b_avalanche_analysis_grouply\BN_246')
load('D:\supplyment_dataANDcode\c_MS_SE_static\MS_SE_HY96_RS.mat', 'syn')
...
clc;clear;close all
cd('D:\supplyment_dataANDcode\b_avalanche_analysis_grouply\BN_246');
load('Avalanches_LMS_1.7.mat')
load('Avalanches_MMS_1.7.mat')
load('Avalanches_HMS_1.7.mat')
figure(...
      'Color', 'w', ...
      'Units', 'Normalized', ...
...
load('Avalanches_LMS_1.7.mat')
SizeFitRange = [3,30];
DurationFitRange = [3,11];
[Avalanche, Criterion, BP_GROUP] = CriticalAnalysis_powerlaw(AvaD_LMS, AvaS_LMS, BinE_LMS, SizeFitRange, DurationFitRange);
%%
clc; clear; close all
cd('D:\supplyment_dataANDcode\b_avalanche_analysis_grouply\BN_246');
load('Avalanches_MMS_1.7.mat')
...
SizeFitRange = [3,30];
DurationFitRange = [3,11];
[Avalanche, Criterion, BP_GROUP] = CriticalAnalysis_powerlaw(AvaD_HMS, AvaS_HMS, BinE_HMS, SizeFitRange, DurationFitRange);
%% bn246 power law fit robustness allsubject
clc; clear; close all
...
save('bn246_powerlaw_diff_size_duration_1.7_LMS.mat');
%%
clc;clear;close all
load('bn246_powerlaw_diff_size_duration_1.7_LMS.mat')
...
xticklabels({num2str(Tau_rc(1)),num2str(Tau_rc(5)),num2str(Tau_rc(10)),...
    num2str(Tau_rc(15)),num2str(Tau_rc(20)),num2str(Tau_rc(25)),num2str(Tau_rc(30)),...
    num2str(Tau_rc(35))});
yticks([1 25 50 75 100 125 150 175])
yticklabels({num2str(Alpha_rc(1)),num2str(Alpha_rc(25)),num2str(Alpha_rc(50)),...
    num2str(Alpha_rc(75)),num2str(Alpha_rc(100)),num2str(Alpha_rc(125)),num2str(Alpha_rc(150)),...
    num2str(Alpha_rc(175))});
xlabel('$\tau$', ...
      'Interpreter','latex',...
       'FontName', 'Arial');
ylabel('$\alpha$', ...
...
title('$|\frac{1-\tau}{1-\alpha}-\gamma|$', ...
      ...
      'FontSize', 18, ...
      'FontWeight', 'bold');
%% bn246 power law fit robustness for MMS
clc; clear; close all
addpath('D:\supplyment_dataANDcode\z_function\CritAnalysisSoftwarePackage2016-04-25')
 load('Avalanches_MMS_1.7.mat')
for Size_min = 1 : 10
...
save('bn246_powerlaw_diff_size_duration_1.7_MMS.mat');
%%
clc;clear;close all
load('bn246_powerlaw_diff_size_duration_1.7_MMS.mat')
Alpha_r = reshape(Alpha,I*J,1);
P_alpha_r = reshape(P_alpha,I*J,1);
Smin2fit_r = reshape(Smin2fit,I*J,1);
Smax2fit_r = reshape(Smax2fit,I*J,1);
...
xticklabels({num2str(Tau_rc(1)),num2str(Tau_rc(10)),num2str(Tau_rc(20)),...
    num2str(Tau_rc(30)),num2str(Tau_rc(40)),num2str(Tau_rc(50))});
...
title('$|\frac{1-\tau}{1-\alpha}-\gamma|$', ...
      ...
      'FontSize', 18, ...
      'FontWeight', 'bold');
%% bn246 power law fit robustness for HMS
clc; clear; close all
addpath('D:\supplyment_dataANDcode\z_function\CritAnalysisSoftwarePackage2016-04-25')
 load('Avalanches_HMS_1.7.mat')
for Size_min = 1 : 10
...
save('bn246_powerlaw_diff_size_duration_1.7_HMS.mat');
%%
clc;clear;close all
load('bn246_powerlaw_diff_size_duration_1.7_HMS.mat')
Alpha_r = reshape(Alpha,I*J,1);
P_alpha_r = reshape(P_alpha,I*J,1);
Smin2fit_r = reshape(Smin2fit,I*J,1);
Smax2fit_r = reshape(Smax2fit,I*J,1);
